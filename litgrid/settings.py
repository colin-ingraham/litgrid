"""
Django settings for litgrid project.
...
SECRET_KEY = 'django-insecure-o#w-m1&=%lt5!%o8p7v=4!&=7$yl!en_*&=y4a#jdx&&+j!04e'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'litgrid',         # <-- Choose a name for your new database
